...
def main():
    ...
    config = tf.compat.v1.compat.v1.ConfigProto()
    config.gpu_options.allow_growth = True
    detector_graph = tf.compat.v1.compat.v1.Graph()
    decoder_graph = tf.compat.v1.compat.v1.Graph()

    with detector_graph.as_default():
        detector_sess = tf.compat.v1.compat.v1.Session()
        detector_model = tf.compat.v1.compat.v1.saved_model.loader.load(detector_sess, [tag_constants.SERVING], args.detector_model)
    ...
    with decoder_graph.as_default():
        decoder_sess = tf.compat.v1.compat.v1.Session()
        decoder_model = tf.compat.v1.compat.v1.saved_model.loader.load(decoder_sess, [tag_constants.SERVING], args.decoder_model)
